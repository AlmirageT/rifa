...
class NumerosFolio extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->from(['contacto@rifopoly.com','Rifo Mi Propiedad'])->subject('Tickets Comprados')->view('mail.mailRespaldo',compact('boleta','numerosComprados','total','usuario'));        
    }
}
