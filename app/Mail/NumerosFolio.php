...
class NumerosFolio extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->from(['contacto@rifomipropiedad.com','Rifo Mi Propiedad'])->subject('Datos Bancarios')->view('mail.mailRespaldo',compact('boleta','numerosComprados','total','usuario'));        
    }
}
