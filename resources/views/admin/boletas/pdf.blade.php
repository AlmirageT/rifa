...
<body>
   <br> <br>
    ...
    <section class="flex" style="padding: 10px 1117px 10px 0px;font-family: helvetica;">
            <div class="ticket" style="border: 1px solid #264492;width: 65%;height: 398px;border-radius: 20px;border-right: none;overflow: hidden;">
                <h6 style="margin-left: 10px;margin-top: 10px;width: 240px;color: #264492;text-align: center;align-content: center;border-radius: 20px;padding: 5px;border: 1px solid #264492;">Comprobante Compra</h6>
                <div class="contenedor-info" style="width: 90%;justify-content: space-between;padding: 10px 20px;background-color: #f5f5f5;border-radius: 20px;margin: auto;font-size: 12px;">
                    <div class="datos-cliente" style="width: 45%;">
                        ...
                        <ul style="list-style: none;margin-left: -42px;">
                            <li>Números Tickets Comprados </li>
                            <strong>{{ $numero->numero }}: ${{ number_format($numero->valorNumero,0,',','.')}}</strong>
                            <li></li>
                            <strong>TOTAL: ${{ number_format($numero->valorNumero,0,',','.')}}</strong>
                        </ul>
                ...
                <div class="contenedor-logo-tkt" style="width: 100%;bottom: 0;">
                    <img class="logo-tkt" style="width: 20%;margin: auto;margin-left: 20px;" src="{{ asset('images/variantes logo rifopoly-05.png') }}" alt="">
                </div>
                
                
            </div>
            
            <div class="contenedor-compra" style="width: 45%;margin-top: -328px;margin-left: 218px;">
                <div class="compra" style="background-color: #f5f5f5;width: 100%;border-radius: 20px;width: 60%;justify-content: space-between;/*! padding: -6px -34px; */background-color: #f5f5f5;border-radius: 20px;margin: auto;font-size: 12px; ">
                    <p class="titulos" style="list-style: none;padding-left: 48px;">Propiedad Ticket</p>
                    <ul style="list-style: none;padding-left: 48px;">
                        @if($propiedad->where('idPropiedad',$numero->idPropiedad)->first()->idPropiedad == $numero->idPropiedad)
                            <li>{{ $propiedad->first()->nombrePropiedad }}</li>
                        @endif
                    </ul>
                </div>
            </div>
            <div class="prepicado" style="border: 1px solid #264492;width: 25%;height: 398px;border-radius: 20px;margin-top: -125px;margin-left: 435px;">
                <h6 style="margin-left: 10px;margin-top: 10px;width: 161px;color: #264492;text-align: center;align-content: center;border-radius: 20px;padding: 5px;border: 1px solid #264492;">Comprobante Compra</h6>
                <div class="contenedor-img" style="width: 100%;margin-top: 30px;">
                    <div class="contenedor-codebar" style="width: 100%;">
                        <img class="code-bar" style="width: 110px;margin: auto;margin-left: 36px;" src="data:image/png;base64, {!! base64_encode($qr) !!}" alt="">
                    </div>
                    ...
                    <div class="contenedor-logo" style="width: 50%;margin: auto;">
                        <img class="logo-prepicado" style="width: 50%;display: block;margin: auto;" src="{{  asset('images/variantes logo rifopoly-07.png') }}" alt="">
                    </div>
                </div>
            </div>
