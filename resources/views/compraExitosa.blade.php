    ...
    <div class="col-md-8 p-lg-5 mx-auto my-5">
        <div class="row">
            <div class="col-md-12 col-12 text-center p-3">
                ...
                <h1 class="display-4 font-weight-normal">¡TU COMPRA YA HA SIDO CONFIRMADA!</h1>
            </div>
...
<script src="https://code.jquery.com/jquery-3.5.1.slim.min.js" integrity="sha384-DfXdz2htPH0lsSSs5nCTpuj/zy4C+OGpamoFVy38MVBnE+IbbVYUew+OrCXaRkfj" crossorigin="anonymous"></script>
  ...
  <footer>
      <div align="center">
        <img src="{{ asset('images/ticket_Mesa de trabajo 1 copia.jpg') }}" class="img-gluid" style="width: 50%"/> <br><br><br>
      </div>
