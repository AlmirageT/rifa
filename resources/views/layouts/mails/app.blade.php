							...
							<div style="width:100% !important;">
								<div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:15px; padding-bottom:15px; padding-right: 0px; padding-left: 0px;">
									<div align="center" class="img-container center fixedwidth" style="padding-right: 0px;padding-left: 0px;">
										<img align="center" alt="Image" border="0" class="center fixedwidth" src="https://rifopoly.com/images/variantes logo rifopoly-05.png" style="text-decoration: none; -ms-interpolation-mode: bicubic; border: 0; height: auto; width: 100%; max-width: 350px; display: block;" title="Image" width="350">
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col num12" style="min-width: 320px; max-width: 700px; display: table-cell; vertical-align: top; width: 680px;">
							<div style="width:100% !important;">
								<div style="border-top:0px solid transparent; border-left:10px solid #F3F3F1; border-bottom:0px solid transparent; border-right:10px solid #F3F3F1; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
									<div style="color:#555555;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;line-height:120%;padding-top:60px;padding-right:60px;padding-bottom:60px;padding-left:60px;">
										<div style="font-family: 'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; font-size: 12px; line-height: 14px; color: #555555;">
												{{--  @if ($data->idTipoFooter == 1)--}}
												<hr style="border: 1px solid; border-color: #EF3340">
												<br>
												{{--  
											@else
												<hr style="border: 1px solid; border-color: #EF3340">
												<br>
												<div>
													<a href="{{ asset('/noticias') }}"><img class="center" src="{{ asset('/img/noticias/') }}/{{ $data->imagenNoticia }}" alt="" style="border-radius: 10px"></a>
													<h3 align="center"><strong>{{ $data->titulo }}</strong></h3>
													<p style="font-size: 16px; font-style: italic;">{!! $data->textoResumen !!}</p><br>
													<p align="center"><a class="button" href="{{ asset('/noticias') }}">Ver noticias</a></p>
												</div>
											@endif--}}
